...
class PersistenciaService {
    ...
    private function esSelect($query) {
        return $this->checkQuery($query, "SELECT");
    }
    ...
    private function esInsert($query) {
        return $this->checkQuery($query, "INSERT");
    }
    ...
    private function esUpdate($query) {
        return $this->checkQuery($query, "UPDATE");
    }
    ...
    private function esDelete($query) {
        return $this->checkQuery($query, "DELETE");
    }
     ...
     * @return bool
     */
    private function checkQuery($query, $type) {
        return substr_count(strtoupper($query), $type) > 0;
    }
